...
<head>
    ...
    <title>Inherent Risk Report</title>
    <style>
        body {
...
<body>
    <div style="padding-top:50%">
        <h1 align="center">Inherent Risk Report</h1>
    ...
    <div style="padding-top:30%">
        ...
        <h1 class="centered"> Inherent Risk Report</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <td width="10%" align="center">Inherent Risk</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="10%" align="center">{{ $rdata->risk_value }}</td>
                <td width="10%" align="center">{{ $status }}</td>
