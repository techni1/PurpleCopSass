...
const NavdataAdmin = () => {
  ...
  const menuItems: any = [
    ...
    //       parentId: "policymanagement",
    //     },
    //     {
    //       id: "userpolicy",
    //       label: "Users Policy",
    //       link: route("userpolicy.index"),
    //       parentId: "policymanagement",
    //     },
    //   ],
    // },
    ...
    //   click: function (e: any) {
    //     e.preventDefault();
    //     setIsEvidence(!isEvidence);
    //     setIscurrentState("Evidence");
    //     updateIconSidebar(e);
    //   },
    //   stateVariables: isEvidence,
    //   subItems: [
    //     {
    //       id: "evidence",
    //       label: "Evidence",
    //       link: route("evidence.index"),
    //       parentId: "evidencemanagement",
    //     },
    //     {
    //       id: "userevidence",
    //       label: "Users Evidence",
    //       link: route("userevidence.index"),
    //       parentId: "evidencemanagement",
    //     },
    //   ],
    // },
    ...
    },
    {
      ...
      subItems: [
...

        {
          ...
          click: function (e: any) {
            e.preventDefault();
            setIsFramework(!isFramework);
            setIscurrentState("Frameworks");
            updateIconSidebar(e);
          },
          stateVariables: isFramework,
          subItems: [
            {
              id: "frameork",
              label: "Framework",
              link: route("framework.index"),
              parentId: "frameworkmangement",
            },
            {
              id: "proviosion",
              label: "Genral Provision",
              link: route("provisions.index"),
              parentId: "frameworkmangement",
            },
            {
              id: "control_domains",
              label: "Control Domains",
              link: route("controldomain.index"),
              parentId: "frameworkmangement",
            },
            {
              id: "functionalgroup",
              label: "Funcational Group",
              link: route("functionalgroup.index"),
              parentId: "frameworkmangement",
            },
            {
              id: "controlcode",
              label: "ControlCode",
              link: route("controlcode.index"),
              parentId: "frameworkmangement",
            },
          ],
        },
      ...
      subItems: [
        {
          ...
          childItems: [
            { id: 1, label: "List", link: "/user" },
            { id: 2, label: "Role", link: "/role" },
            { id: 2, label: "Permission", link: "/permission" },
          ],
        },
        {
          id: "signIn",
