...
export interface LayoutState {
  ...
  backgroundImageType: BACKGROUND_IMAGE_TYPES.NONE | BACKGROUND_IMAGE_TYPES.IMG1 | BACKGROUND_IMAGE_TYPES.IMG2 | BACKGROUND_IMAGE_TYPES.IMG3;
}
/*
export const initialState: LayoutState = {
  ...
  backgroundImageType: BACKGROUND_IMAGE_TYPES.IMG3
};*/
...
const LayoutSlice = createSlice({
  ...
  reducers: {
    ...
    changeBackgroundImageAction(state: any, action: any) {
