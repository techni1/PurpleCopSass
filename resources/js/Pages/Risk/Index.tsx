...
export default function Index({ auth, risks, success }: any) {
  return (
    <React.Fragment>
      <Head title="Risk Management - Risk Add" />

      <div className="page-content">
        <Container fluid>
          {/* <pre>{JSON.stringify(risks, undefined, 2)}</pre> */}
          <BreadCrumb title="Risk" pageTitle="Dashboard" />
          <Row>
            <Col>
              <div className="h-100">
                <Section />
          ...
          <Row>
            <Col lg={12}>
              <Card>
                <Card.Body>
                  <SearchTable routeTo="risk.show" tableData={risks} />
                </Card.Body>
              </Card>
            </Col>
          </Row>
