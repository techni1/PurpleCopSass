...
export default function Index({ auth, criticality, success }: any) {
    return (
        <React.Fragment>
            <Head title="Asset Location" />

            <div className="page-content">
                <Container fluid>
                    {/* <pre>{JSON.stringify(frameworks, undefined, 2)}</pre> */}
                    <BreadCrumb title="Asset Location" pageTitle="Dashboard" />
                    <Row>
                        <Col>
                            <div className="h-100">
                                <Section />
