                    ...
                    <Card.Body className="p-4">
                      ...
                      <div className="p-2 mt-4">
                        <div className="text-muted text-center mb-4 mx-lg-3">
                          ...
                          <p>
                            Please enter the 4 digit code sent href{" "}
                        ...
                        <div className="mt-3">
                          <Button className="w-100 btn-primary">Confirm</Button>
                        </div>
                      </div>
                    </Card.Body>
                  </Card>
