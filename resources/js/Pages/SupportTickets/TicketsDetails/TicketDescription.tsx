                ...
                <Card>
                    ...
                    <Card.Body className="p-4">
                        ...
                        <form action="#" className="mt-3">
                            <Row className="g-3">
                                <Col lg={12}>
                                     <Form.Label htmlFor="exampleFormControlTextarea1" className="form-label">Leave a Comments</Form.Label>
                                ...
                                <Col lg={12} className="text-end">
                                    <a href="#" className="btn btn-primary">Post Comments</a>
                                </Col>
                            </Row>
                        </form>
                    </Card.Body>
