                            ...
                            <Row>
                                ...
                                <div className="col-md-auto mt-md-0 mt-4">
                                    <div className="hstack gap-1 flex-wrap">
                                        ...
                                        <Dropdown >
                                            <Dropdown.Toggle as="button" type="button" className="btn py-0 fs-16 text-body arrow-none">
                                                <i className="ri-share-line"></i>
                                            </Dropdown.Toggle>

                                            <Dropdown.Menu>
                                                <li><Dropdown.Item><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View</Dropdown.Item></li>
                                                <li><Dropdown.Item><i className="ri-share-forward-fill align-bottom me-2 text-muted"></i> Share with</Dropdown.Item></li>
