...
const TicketsData = () => {
  ...
  const { ticketsList, isTicketSuccess, error }: any = useSelector(
    selectTicketProperties
  );
        ...
        >
          <Modal.Body>
            <Row className="g-3">
              <Col lg={12}>
                <div>
                  <Form.Label htmlFor="tasksTitle-field" className="form-label">
                    Title
                  </Form.Label>
                  <Form.Control
                    name="title"
              ...
              <Col lg={6}>
                <Form.Label htmlFor="duedate-field" className="form-label">
                  Due Date
                </Form.Label>
                <Flatpickr
                  name="dueDate"
              ...
              <Col lg={6}>
                <Form.Label htmlFor="ticket-status" className="form-label">
                  Status
                </Form.Label>
                <select
                  name="status"
              ...
              <Col lg={6}>
                <Form.Label htmlFor="priority-field" className="form-label">
                  Priority
                </Form.Label>
                <select
                  name="priority"
