                ...
                <div className="card-body">
                  ...
                  <div className="live-preview">
                    <form action="#" className="row g-3">
                      ...
                      <Col md={2}>
                        <Form.Label htmlFor="inputZip" className="form-label">
                          Zip
                        </Form.Label>
                        <Form.Control
                          type="text"
                      ...
                      <Row className="g-3">
                        <Col lg={6}>
                          <div className="form-floating">
                            <Form.Control
                              ...
                              placeholder="Enter your firstname"
                            />
                            <Form.Label htmlFor="firstnamefloatingInput">
                              First Name
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={6}>
                          <div className="form-floating">
                            <Form.Control
                              ...
                              placeholder="Enter your Lastname"
                            />
                            <Form.Label htmlFor="lastnamefloatingInput">
                              Last Name
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            <Form.Control
                              ...
                              placeholder="Enter your email"
                            />
                            <Form.Label htmlFor="emailfloatingInput">
                              Email Address
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            ...
                            />
                            <Form.Label htmlFor="passwordfloatingInput">
                              Password
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            <Form.Control
                              ...
                              placeholder="Confirm password"
                            />
                            <Form.Label htmlFor="passwordfloatingInput1">
                              Confirm Password
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            <Form.Control
                              ...
                              placeholder="Enter your city"
                            />
                            <Form.Label htmlFor="cityfloatingInput">
                              City
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            ...
                            <Form.Label htmlFor="floatingSelect">
                              Country
                            </Form.Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            ...
                            />
                            <Form.Label htmlFor="zipfloatingInput">
                              Zipcode
                            </Form.Label>
                          </div>
                        </Col>
