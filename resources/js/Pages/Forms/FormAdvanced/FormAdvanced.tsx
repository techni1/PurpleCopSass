                ...
                <Card.Body>
                  <Row className="g-3">
                    <Col lg={6}>
                      ...
                      <div className="mt-3">
                        <Form.Label>
                          Select input flag with img & name
                        </Form.Label>
                        <Dropdown>
                          <Dropdown.Toggle
                            as="input"
                      ...
                      <div className="mt-3">
                        <Form.Label>
                          Search input false in dropdown menu
                        </Form.Label>
                        <Dropdown>
                          <Dropdown.Toggle
                            as="input"
                    ...
                    <Col lg={6}>
                      ...
                      <div className="mt-3">
                        <Form.Label>
                          Select input with buttons & Flag
                        </Form.Label>
                        <Dropdown className="input-group">
                          <Dropdown.Toggle
                            as="button"
