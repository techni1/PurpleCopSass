...
const SearchTable = ({ routeTo, tableData }: any) => {
  ...
  const handleDeleteClick = (permission: any) => {
    ...
    setModalMessage(`Permission ${permission.name} will be deleted !!`);
  ...
  const deleteClient = () => {
    router.delete(route("permission.destroy", permissionToDelete));
    setShowModal(false);
  };
          ...
          <Dropdown>
            ...
            <Dropdown.Menu className="dropdown-menu-end">
              <Dropdown.Item className="dropdown-item edit-item-btn">
                <Link href={route("permission.edit", info.row.original.id)}>
