...
import { CORRECTIVE_ACTION_STATUS_CLASS_MAP, CORRECTIVE_ACTION_STATUS_TEXT_MAP, CORRECTIVE_STATUS_CLASS_MAP, SUPPORT_STATUS_CLASS_MAP, SUPPORT_STATUS_TEXT_MAP, SUPPORTTEM_ATTENDANCE_STATUS_CLASS_MAP, SUPPORTTEM_ATTENDANCE_STATUS_TEXT_MAP, SUPPORTTEM_STATUS_CLASS_MAP, SUPPORTTEM_STATUS_TEXT_MAP } from "../../../Components/constants/statusConstant";
    ...
    () => [
      ...
      
      {
        ...
        cell: (info: any) => {
          ...
          const statusText = SUPPORTTEM_ATTENDANCE_STATUS_TEXT_MAP[statusValue]; // Map the status value to the corresponding text
          return (
            <span className={SUPPORTTEM_ATTENDANCE_STATUS_CLASS_MAP[statusValue]}>
              {statusText}
            </span>
          );
        },
      ...
      
      {
        ...
        cell: (info: any) => {
          const statusValue = info.getValue(); // Get the status value
          const statusText = SUPPORTTEM_STATUS_TEXT_MAP[statusValue]; // Map the status value to the corresponding text
          return (
            <span className={SUPPORTTEM_STATUS_CLASS_MAP[statusValue]}>
              {statusText}
            </span>
          );
        },
