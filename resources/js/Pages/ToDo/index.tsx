...
const ToDoList = () => {
  ...
  const todosData = createSelector(selectTodoState, (state: any) => ({
    todos: state.todos,
    projects: state.projects,
  }));
  // Inside your component
  const { todos, projects }: any = useSelector(todosData);
        ...
        <Modal.Body>
          ...
          >
            ...
            <div className="mb-3 position-relative">
              <Form.Label htmlFor="task-assign-input" className="form-label">
                Assigned To
              </Form.Label>
