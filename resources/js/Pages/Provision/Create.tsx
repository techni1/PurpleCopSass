...
export default function Create({ frameworks, provision_categories }: any) {
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                {/* <pre>{JSON.stringify(provision_categories, undefined, 2)}</pre> */}
                <Card.Body>
                  <form onSubmit={onSubmit}>
                    <Row className="p-4 g-3">
                      ...
                      <Col xl={4}>
                        ...
                        <select
                          className="form-control form-select"
                          defaultValue={data.framework_name}
                          onChange={(e: any) =>
