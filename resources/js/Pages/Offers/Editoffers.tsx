    ...
    <React.Fragment>
      ...
      >
        <Modal.Header className="border-bottom" closeButton>
          <Modal.Title id="ModalExampleLabel">Edit Offer</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Card>
              ...
              <Card.Body>
                <div className="col-md-12">
                  <div className="row">
                    ...
                    <div className="col-md-6 pt-2">
                      <Form.Label htmlFor="percentage" className="form-label">
                        Percentage(%)
                      </Form.Label>
                      <Form.Control
                        id="percentage"
                    ...
                    <div className="col-md-6 pt-2">
                      ...
                      <select
                        ...
                        name="offer_status"
                        value={data.offer_status}
                        onChange={(e: any) =>
                          setData("offer_status", e.target.value)
                        }
                        required
                      >
                        <option value=""></option>
