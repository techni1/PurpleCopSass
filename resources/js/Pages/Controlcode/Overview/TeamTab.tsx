...
import { Card, Col, Modal, Row, Dropdown, Form, Button, } from 'react-bootstrap';
                ...
                <div className="col-sm">
                    <div className="d-flex">
                        <div className="search-box me-2">
                            <Form.Control type="text" className="form-control" placeholder="Search member..." />
                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Dropdown className="col text-end">
                                        ...
                                        <Dropdown.Menu className="dropdown-menu-end">
                                            <li><Dropdown.Item><i className="ri-eye-fill text-muted me-2 align-bottom"></i>View</Dropdown.Item></li>
                                            <li><Dropdown.Item><i className="ri-star-fill text-muted me-2 align-bottom"></i>Favourite</Dropdown.Item></li>
                                            <li><Dropdown.Item><i className="ri-delete-bin-5-fill text-muted me-2 align-bottom"></i>Delete</Dropdown.Item></li>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                </Row>
                            </div>
                        ...
                        <Row className="align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Henry Baird</h5></Link>
                        ...
                        <Row className="align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Frank Hook</h5></Link>
                        ...
                        <Row className="align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Jennifer Carter</h5></Link>
                        ...
                        <Row className="align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Megan Elmore</h5></Link>
                        ...
                        <Row className="align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Alexis Clarke</h5></Link>
                        ...
                        <div className="row align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Nathan Cole</h5></Link>
                        ...
                        <div className="row align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Joseph Parker</h5></Link>
                                        <p className="text-muted mb-0">Team Leader & HR</p>
                                    </div>
                                </div>
                            </Col>
                        ...
                        <div className="row align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Erica Kernan</h5></Link>
                        ...
                        <div className="row align-items-center team-row">
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img">
                                    ...
                                    <div className="team-content">
                                        <Link href="#" className="d-block"><h5 className="fs-16 mb-1">Donald Palmer</h5></Link>
            ...
            <div className="row g-0 text-center text-sm-start align-items-center mb-3">
                ...
                <div className="col-sm-6">
                    <ul className="pagination pagination-separated justify-content-center justify-content-sm-end mb-sm-0">
                        <li className="page-item disabled"> <Button variant='link' className="page-link"><i className="mdi mdi-chevron-left"></i></Button> </li>
                        <li className="page-item"> <Button variant='link' className="page-link">1</Button> </li>
                        <li className="page-item active"> <Button variant='link' className="page-link">2</Button> </li>
                        <li className="page-item"> <Button variant='link' className="page-link">3</Button> </li>
                        <li className="page-item"> <Button variant='link' className="page-link">4</Button> </li>
                        <li className="page-item"> <Button variant='link' className="page-link">5</Button> </li>
                        <li className="page-item"> <Button variant='link' className="page-link"><i className="mdi mdi-chevron-right"></i></Button> </li>
                    </ul>
                </div>
            </div>

            <Modal show={modal} onHide={openModal} centered className="border-0">
                <Modal.Header className="p-3 ps-4 bg-primary-subtle" closeButton>
                ...
                <Modal.Body className="p-4">
                    ...
                    <div className="mb-4 d-flex align-items-center">
                        ...
                        <div className="avatar-group justify-content-center">
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Brent Gonzalez">
                                <div className="avatar-xs">
                                    <img src={avatar3} alt="" className="rounded-circle img-fluid" />
                                </div>
                            </Link>
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Sylvia Wright">
                                <div className="avatar-xs">
                            ...
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Ellen Smith">
                                <div className="avatar-xs">
                        ...
                        <div className="vstack gap-3">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Nancy Martino</Link></h5>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Henry Baird</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Frank Hook</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Jennifer Carter</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Alexis Clarke</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1">
                                    <h5 className="fs-13 mb-0"><Link href="#" className="text-body d-block">Joseph Parker</Link></h5>
                                </div>
                                <div className="flex-shrink-0">
                                    <button type="button" className="btn btn-light btn-sm">Add</button>
                                </div>
