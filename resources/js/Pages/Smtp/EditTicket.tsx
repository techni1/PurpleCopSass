...
export default function EditTicket({ show, setShow, bank }: any) {
    ...
    useEffect(() => {
        if (bank) {
            setData({
                ...
                bank_accountno: bank.bank_accountno || "",
                bank_ifsccode: bank.bank_ifsccode || "",
                bank_swiftcode: bank.bank_swiftcode || "",
                notes: bank.notes || "",
            })
        }
    }, [bank]);
    ...
    const onSubmit = (e: any) => {
        e.preventDefault();
        patch(route("bankdetails.update", bank.id), {
            preserveScroll: true,
            onSuccess: () => {
            ...
            >
                <Modal.Header className="border-bottom" closeButton>
                    <Modal.Title id="ModalExampleLabel">
                        Edit {data.bank_accountname}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>

                    {/* <pre>{JSON.stringify(bank, undefined, 2)}</pre> */}
                    <Card>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            ...
                                            <input
                                                ...
                                                name="bankid"
                                                value={bank.id}
                                                onChange={(e: any) => setData("bankid", e.target.value)}
                                            />
