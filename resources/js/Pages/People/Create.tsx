  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Add Employee" pageTitle="Dashboard" />
          <Row>
            <Col lg={12}>
              <Card>
                <Card.Body>
                  <form onSubmit={onSubmit}>
                    <Row className="p-4">
                      ...
                      <Col md={6}>
                        <Row>
                          {/* <Col>
                            <Form.Label htmlFor="agent" className="form-label">
                              Agent Installed{" "}
                          ...
                          <Col>
                            ...
                            <select
                              className="form-control form-select"
                              onChange={(e: any) =>
                                setData("antivirus", e.target.value)
                              }
                              required
                            >
                              <option></option>
