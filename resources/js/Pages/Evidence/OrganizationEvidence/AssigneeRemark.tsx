...
export default function AssigneeRemark({
  id,
  assignee,
  assigneeRemark,
  setAssigneeRemark,
  ...
  const onSubmit = async (e: any) => {
    ...
    try {
      //@ts-ignore
      const response = await axios.post("/add-evidence-assignee-remark", {
        ...data,
      });
      if (response.data.success) {
        setAssigneeRemark(data.remark);
        reset();
      }
    } catch (error) {
