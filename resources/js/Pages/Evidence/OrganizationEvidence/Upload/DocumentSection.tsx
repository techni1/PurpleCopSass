  ...
  return (
    <>
            ...
            <Card.Body className="p-4">
              {isDocumentLoading ? (
                ...
                <>
                  ...
                  {((evidence.assignee == null && userRole == "Admin") ||
                    (evidence.assignee && evidence.assignee.id == user.id)) &&
                    documents.length == 0 &&
                    files.length == 0 && (
                      <Row>
                        <Col>
                      ...
                      <Col> */}
                          ...
                          href={route("editor.editor", evidence.id)}
                        >
                          <i className="ri-edit-box-line" /> Open Editor
                        </Link> */}
                        </Col>
      ...
      <AttachmentModal
        ...
        setProgressBar={setProgressBar}
        setAssigneeStatus={setAssigneeStatus}
        modelType={"App\\Models\\OrganizationEvidence"}
        category={"Evidence"}
      />
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            <h4 className="card-title mb-0 ">{evidence.evidence.name}</h4>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row>
