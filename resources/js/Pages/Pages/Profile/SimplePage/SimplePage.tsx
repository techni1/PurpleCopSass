      ...
      <div className="page-content">
        <Container fluid>
          <div className="profile-foreground position-relative mx-n4 mt-n4">
            <div className="profile-wid-bg bg-transparent border-top"></div>
          </div>
              ...
              <Col>
                <div className="p-2">
                  ...
                  <div className="hstack text-muted gap-1">
                    ...
                    <div>
                      <i className="ri-building-line me-1 fs-16 align-bottom text-body"></i>
                      Themesbrand
                    </div>
                  </div>
                </div>
              ...
              <div>
                <Tab.Container defaultActiveKey="overview">
                  <div className="d-flex">
                    <Nav
                      className="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1 mx-3"
                      role="tablist"
                      as="ul"
                    >
                                                  ...
                                                  <div className="d-flex">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                      ...
                                                      <small className="text-muted">
                                                        We has changed 2
                                                        attributes on 05:16PM
                                                      </small>
                                                    </div>
                                                  </div>
                                                </button>
                                              </Accordion.Header>
                                              <Accordion.Body className="ms-2 ps-5">
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <Accordion.Body className="ms-2 ps-5">
                                                ...
                                                spacing depending on the
                                                situation and try, try again
                                                until it looks right, and each
                                                letter has the perfect spot of
                                                its own.
                                              </Accordion.Body>
                                            </Accordion.Item>
                                            <Accordion.Item
                                            ...
                                            >
                                              ...
                                              <Accordion.Body className="ms-2 ps-5 fst-italic">
                                            ...
                                            >
                                              ...
                                              <Accordion.Body className="ms-2 ps-5">
                                                <p className="text-muted fst-italic mb-2">
                                                  ...
                                                  only templates using boostrap
                                                  5.1.3 so far). I integrated it
                                                  into a Rails 6 project. Needs
                                                  manual integration work of
                                                  course but the template
                                      ...
                                      <tr key={key}>
                                        ...
                                        <td>
                                          <Dropdown dir="start">
                                            <Dropdown.Toggle
                                              as="a"
                                              className="btn btn-light btn-icon arrow-none"
                                              id="dropdown.MenuLink15"
                                              role="button"
                                            >
