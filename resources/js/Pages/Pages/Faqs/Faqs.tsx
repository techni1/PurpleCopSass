    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <Row>
            <Col lg={12}>
              <Card className="rounded-0 bg-primary-subtle mx-n4 mt-n4 border-top">
                <div className="px-4">
                  <Row>
              ...
              <Row className="justify-content-evenly mb-4">
                <Col lg={4}>
                  <div className="mt-3">
                    ...
                    <Accordion
                      className="accordion-border-box"
                      defaultActiveKey="0"
                    >
                      ...
                      <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                          he wise man therefore always holds in these matters to
                          this principle of selection: he rejects pleasures to
                          secure other greater pleasures, or else he endures
                          pains to avoid worse pains.But I must explain to you
