                    ...
                    <Nav className="nav-tabs nav-tabs-custom" role="tablist">
                      ...
                      <li className="nav-item ms-auto">
                        <Dropdown show={dropdownOpen} onClick={toggledropDown}>
                          <Dropdown.Toggle
                            className="nav-link fw-medium text-reset mb-n1 btn btn-secondary"
                            role="button"
                          >
                      ...
                      <Tab.Pane eventKey={1}>
                        <div className="pb-3">
                          ...
                          <p className="text-muted mb-2">
                            ...
                            lines of code. You can start small and large
                            projects or update design in your existing project
                            using Velzon it is very quick and easy as it is
                        ...
                        <div className="py-3">
                          ...
                          <p className="text-muted mb-2">
                            ...
                            based interface, eCommerce, Crypto, CRM, CMS,
                        ...
                        <div className="py-3">
                          ...
                          <p className="text-muted mb-2">
                            ...
                            ( Dark, Light & RTL ) which are managed by SCSS
                            only. You can simply change to any layouts or mode
                            by changing a couple of lines code.
                          </p>
                          <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                            <li className="list-inline-item me-3">
                              <i className="ri-thumb-up-line align-middle me-1"></i>
                        ...
                        <div className="py-3">
                          ...
                          <p className="text-muted mb-2">
                            ...
                            with Bootstrap ^5.1.3. It has 5+ different layouts
                            and 3 modes ( Dark, Light & RTL ) which are managed
                            by SCSS only. You can simply change to any layouts
                            or mode by changing a couple of lines code.
                          </p>
                          <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                            <li className="list-inline-item me-3">
                              <i className="ri-thumb-up-line align-middle me-1"></i>
