                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Nancy Martino</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Henry Baird</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Frank Hook</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Donald Palmer</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Erica Kernan</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Alexis Clarke</Link></h5>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Marie Ward</Link></h5>
                                    <p className="text-muted mb-0 ff-secondary">Full Stack Developer</p>
                                </Card.Body>
                            </Card>
                        ...
                        <Col lg={3} sm={6}>
                            <Card>
                                <Card.Body className="text-center p-4">
                                    ...
                                    {/* <!-- end card body --> */}
                                    <h5 className="mb-1"><Link href="/pages-profile" className="text-body">Jack Gough</Link></h5>
                    ...
                    <Row>
                        <div className="col-lg-12">
                            <div className="text-center mt-2">
                                <Link href="/pages-team" className="btn btn-primary">View All Members <i
