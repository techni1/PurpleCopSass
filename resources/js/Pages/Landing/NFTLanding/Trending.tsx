                                    ...
                                    <SwiperSlide>
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <h5 className="mb-0 fs-16"><Link href="#!">Artwork <span className="badge bg-success-subtle text-success">206</span></Link></h5>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <Link href="#!" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-16"><Link href="#!">Crypto Card <span className="badge bg-success-subtle text-success">743</span></Link></h5>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <Link href="#!" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-16"><Link href="#!">Music <span className="badge bg-success-subtle text-success">679</span></Link></h5>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <Link href="#!" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-16"><Link href="#!">Games <span className="badge bg-success-subtle text-success">341</span></Link></h5>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <Link href="#!" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-16"><Link href="#!">Photography <span className="badge bg-success-subtle text-success">1452</span></Link></h5>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                </div>
