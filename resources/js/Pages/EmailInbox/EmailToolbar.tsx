...
import { Col, Nav, Row, Dropdown, Tooltip, Button, Modal, ProgressBar, Card, Alert, Form, OverlayTrigger, Accordion } from 'react-bootstrap';
...
const EmailToolbar = () => {
    ...
    }: any = useSelector(selectmailProperties);
                ...
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    >
                        <div className="mail-list mt-3">
                            <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "all"); }} className={classnames({ active: activeTabs === 'all' })}>
                            ...
                            <Button as='a' variant="link" onClick={() => { toggleTab("inbox", "all", "all"); }} className={classnames({ active: activeTabs === 'inbox' })}>
                            ...
                            <div>
                                <Button as='a' variant="link" onClick={() => { toggleTab("sent", "all", "all"); }} className={activeTabs === "sent" ? "active" : ''}>
                            ...
                            <div>
                                <Button as='a' variant="link" onClick={() => { toggleTab("draft", "all", "all"); }} className={activeTabs === "draft" ? "active" : ''}>
                            ...
                            <div>
                                <Button as='a' variant="link" onClick={() => { toggleTab("spam", "all", "all"); }} className={activeTabs === "spam" ? "active" : ''}>
                            ...
                            <Button as='a' variant="link" onClick={() => { toggleTab("trash", "all", "all"); }} className={activeTabs === "trash" ? "active" : ''}>
                                <i className="ri-delete-bin-5-fill me-3 align-middle fw-medium"></i>
                                <span className="mail-list-link">
                                    Trash
                                </span>
                            </Button>
                            <Button as='a' variant="link" onClick={() => { toggleTab("starred", "all", "all"); }} className={activeTabs === "starred" ? "active" : ''}>
                                <i className="ri-star-fill me-3 align-middle fw-medium"></i>
                                <span className="mail-list-link">
                                    Starred
                                </span>
                            </Button>
                            <Button as='a' variant="link" onClick={() => { toggleTab("important", "all", "all"); }} className={activeTabs === "important" ? "active" : ''}>
                        ...
                        <div>
                            ...
                            <div className="mail-list mt-1">
                                <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "support"); }} className={isLabelTab === "support" ? "active" : ''}>
                                ...
                                <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "freelance"); }} className={isLabelTab === "freelance" ? "active" : ''}>
                                ...
                                <div>
                                    <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "social"); }} className={isLabelTab === "social" ? "active" : ''}>
                                ...
                                <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "friend"); }} className={isLabelTab === "friend" ? "active" : ''}>
                                ...
                                <Button as='a' variant="link" onClick={() => { toggleTab("all", "all", "family"); }} className={isLabelTab === "family" ? "active" : ''}>
                        ...
                        <div className="border-top border-top-dashed pt-3 mt-3">
                            ...
                            {chatData.map((item: any, key: any) => (<a href="#" className="d-flex align-items-center" key={key}>
                        ...
                        <Row className="mt-n2 mb-3 mb-sm-0">
                            ...
                            <div className="col-sm order-3 order-sm-2">
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <Form.Check.Input className="form-check-input" type="checkbox" value="" id="checkall"
                                            onChange={() => {
                                                checkedAll();
                                            }}
                                        />
                                        <Form.Check.Label className="form-check-label" htmlFor="checkall"></Form.Check.Label>
                                    </div>
                                    ...
                                    <div id="email-topbar-actions" style={{ display: "none" }}>
                                        ...
                                        <OverlayTrigger
                                                key="tooltip-1"
                                                placement="top"
                                                overlay={<Tooltip id="Tooltip1">Archive</Tooltip>}
                                            >
                                                <Button as='a'
                                                    variant="link"
                                                    size="sm"
                                            ...
                                            <OverlayTrigger
                                                key="tooltip-2"
                                                placement="top"
                                                overlay={<Tooltip id="Tooltip2">Report Spam</Tooltip>}
                                            >
                                                <Button as='a'
                                                    variant="link"
                                                    size="sm"
                                            ...
                                            <OverlayTrigger
                                                key="tooltip-3"
                                                placement="top"
                                                overlay={<Tooltip id="Tooltip3">Trash</Tooltip>}
                                            >
                                                <Button as='a'
                                                    variant="link"
                                                    size="sm"
                                    ...
                                    <Dropdown>
                                        <Dropdown.Toggle as="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 arrow-none">
                                            <i className="ri-price-tag-3-fill align-bottom"></i>
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu className="dropdown-menu-end">
                                            <Dropdown.Item onClick={() => labeledEmail("support")}>Support</Dropdown.Item>
                                            <Dropdown.Item onClick={() => labeledEmail("freelance")}>Freelance</Dropdown.Item>
                                            <Dropdown.Item onClick={() => labeledEmail("social")}>Social</Dropdown.Item>
                                            <Dropdown.Item onClick={() => labeledEmail("friends")}>Friends</Dropdown.Item>
                                            <Dropdown.Item onClick={() => labeledEmail("family")}>Family</Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                    ...
                                    <Dropdown>
                                        ...
                                        <Dropdown.Menu className="dropdown-menu-end">
                                            <Dropdown.Item onClick={() => readAll("read")}>Mark all as Read</Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>

                                    <Alert variant="warning" style={{ display: "none" }} className="unreadConversations-alert px-4 fade" id="unreadConversations">
                            ...
                            <div className="col-auto order-2 order-sm-3">
                                <div className="d-flex gap-sm-1 email-topbar-link">
                                    ...
                                    <Dropdown>
                                        ...
                                        <Dropdown.Menu className="dropdown-menu-end">
                                            <Dropdown.Item onClick={() => readAll("unread")}>Mark as Unread</Dropdown.Item>
                                            <Dropdown.Item>Mark as Important</Dropdown.Item>
                                            <Dropdown.Item>Add to Tasks</Dropdown.Item>
                                            <Dropdown.Item onClick={() => favouriteBtn("")}>Add Star</Dropdown.Item>
                                ...
                                {filteredMails.length === 0 ? (
                                    ...
                                    <li className={classnames({ unread: item.unread })} key={key} id={item.forId}>
                                        <div className="col-mail col-mail-1">
                                            ...
                                            <a className="text-start title" onClick={() => sidebarToggle(item)}>{item.name} {" "} {item.number} </a>
                                        </div>
                                        <div className="col-mail col-mail-2" onClick={() => sidebarToggle(item)}>
                                            <a href='#' className="text-start subject"> {item.badge ? <span className={"badge me-2 bg-" + item.badgeClass}>{item.badge}</span> : null} {item.subject} - <span className="teaser">{item.teaser}</span>
                                            </a>
                ...
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    <SimpleBar className="mx-n4 px-4 email-detail-content-scroll">
                        ...
                        <Accordion defaultActiveKey="3" flush >
                            <Accordion.Item className="border-dashed left" eventKey='1'>
                                <Accordion.Header >
                            ...
                            <Accordion.Item eventKey="2" className="border-dashed right">
                                <Accordion.Header>
                            ...
                            <Accordion.Item eventKey='3' className="border-dashed left">
                                <Accordion.Header>
                                    <a href='/#' className="btn w-100 text-start px-0 bg-transparent shadow-none"
                                ...
                                <div className="bg-light px-2 py-1 rouned-bottom border">
                                    <Row>
                                        ...
                                        <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15" id="Bold1"><i className="ri-bold align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15" id="Italic1"><i className="ri-italic align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15" id="Link1"><i className="ri-link align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15" id="Image1"><i className="ri-image-2-line align-bottom"></i></Button>
                                            </OverlayTrigger>
                                        </Col>
                                        <Col className="col-auto">
                                        <Dropdown>
                                                <Button variant="success" className="btn-sm" onClick={(e: any) => e.preventDefault()}><i className="ri-send-plane-2-fill align-bottom" /></Button>
                                                <Dropdown.Toggle as="button" className="btn btn-success btn-sm" split onClick={(e: any) => e.preventDefault()}>
                                                </Dropdown.Toggle>
                                                <Dropdown.Menu >
                                                    <li>
                                                        <Dropdown.Item href="#">
                                                ...
                                                <div className="ctext-wrap">
                                                    ...
                                                    <Dropdown className="align-self-start message-box-drop">
                                                        ...
                                                        <Dropdown.Menu>
                                                            ...
                                                            <Dropdown.Item onClick={(e: any) => copyMessage(e.target)}><i className="ri-file-copy-line me-2 text-muted align-bottom"></i>Copy</Dropdown.Item>
                                                            <Dropdown.Item onClick={() => deleteChat(item)}><i className="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</Dropdown.Item>
                                                        </Dropdown.Menu>
                                                    </Dropdown>
                        ...
                        <div className="border-top border-top-dashed">
                            <Row className="g-2 mx-3 mt-2 mb-3">
                                <Col className="col">
                                    ...
                                    <Form.Control type="text" className="form-control border-light bg-light" placeholder="Enter Message..." value={text} onKeyDown={onKeyPress} onChange={e => setText(e.target.value)} />
                                    </div>
                                </Col>
                                <Col className="col-auto">
