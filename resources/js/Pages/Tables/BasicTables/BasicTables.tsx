          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-striped</code> className to add
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-dark</code> className to set dark color
                    table body and <code>table-success</code> className to set
                    success color table body respectively. use{" "}
                    <code>table-</code> className with different color variation
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-hover</code> className to enable a hover
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted mb-4">
                    Use <code>table-card</code> className to show card-based
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-active</code> className to highlight a table
                    row or cell.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-bordered</code> className to show borders on
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>border-</code> className with color variation
                    className to set table border color.
                  </p>
          ...
          <Row>
            <Col xl="6">
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-sm</code> className to create any table more
              ...
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    ...
                    className to create &lt;thead&gt; appear light or dark.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="align-middle table-nowrap mb-0">
            ...
            <Col xl={6}>
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>table-</code> className with below-mentioned color
                    variation className within &lt;tr&gt; to set color on table
                    row.
                  </p>
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>table-responsive</code> className to make any
                    table responsive across all viewports. Responsive tables
