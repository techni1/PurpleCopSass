...
const FileManager = () => {
  ...
  const { folders, files }: any = useSelector(selectFileManager);
  ...
  return (
    <React.Fragment>
                  ...
                  <ul className="list-unstyled file-manager-menu">
                    <li>
                      ...
                      <div className="collapse show" id="collapseExample">
                        <ul className="sub-menu list-unstyled">
                          <li>
                            <Button as="a" variant="link" className="p-0">
                              Assets
                            </Button>
                          </li>
                          <li>
                    ...
                    <li>
                      <Button
                        ...
                        variant="link"
                        className={
                          filterActive === "Documents" ? "active p-0" : "p-0"
                        }
                    ...
                    <li>
                      <Button
                        ...
                        variant="link"
                        className={
                          filterActive === "Media" ? "active p-0" : "p-0"
                        }
                    ...
                    <li>
                      <Button
                        ...
                        variant="link"
                        className={
                          filterActive === "Recents" ? "active p-0" : "p-0"
                        }
                    ...
                    <li>
                      <Button
                        ...
                        variant="link"
                        className={
                          filterActive === "Important" ? "active p-0" : "p-0"
                        }
                    ...
                    <li>
                      <Button
                        ...
                        variant="link"
                        className={
                          filterActive === "Deleted" ? "active p-0" : "p-0"
                        }
              ...
              <div className="mx-n3 pt-4 px-4 file-manager-content-scroll overflow-x-hidden overflow-y-auto">
                          ...
                          <CardBody>
                            <div className="d-flex mb-1">
                              ...
                              <Dropdown>
                                <Dropdown.Toggle
                                  as="button"
                                  className="arrow-none btn btn-ghost-primary btn-icon btn-sm dropdown"
                                >
                                  <i className="ri-more-2-fill fs-16 align-bottom" />
                                </Dropdown.Toggle>
                                <Dropdown.Menu className="dropdown-menu-end">
                                  <Dropdown.Item className="view-item-btn">
                                    Open
                                  </Dropdown.Item>
                                  <Dropdown.Item
                ...
                <div>
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div className="flex-shrink-0">
                      <button
                        className="btn btn-primary createFile-modal"
                            ...
                            <td>
                              <div className="d-flex gap-3 justify-content-center">
                                ...
                                <Dropdown dir="start">
                                  <Dropdown.Toggle
                                    as="button"
                                    className="arrow-none btn btn-light btn-icon btn-sm dropdown"
      ...
      <Modal
        ...
        show={modalFolder}
        onHide={() => setModalFolder(!modalFolder)}
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            <div className="mb-4">
              <Form.Label htmlFor="foldername-input" className="form-label">
                Folder Name
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <Row>
              <Col lg={6}>
                <Form.Label htmlFor="folderFile-input" className="form-label">
                  Files
                </Form.Label>
                <Form.Control
                  type="text"
              ...
              <Col lg={6}>
                <Form.Label htmlFor="size-input" className="form-label">
                  Size
                </Form.Label>
                <Form.Control
                  type="text"
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            <div className="mb-4">
              <Form.Label htmlFor="filename-input" className="form-label">
                File Name
              </Form.Label>
              <Form.Control
                type="text"
