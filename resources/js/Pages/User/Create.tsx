...
export default function Create({
  ...
  //   user.data.role.map((role: any) => ({ value: role.name, label: role.name }))
  // );
      ...
      <Layout>
        ...
        <Container fluid>
          <div className="page-content">
            <BreadCrumb title="Create User" pageTitle="User Mangement" />
            <div className="col-md-12">
              {/* <pre>{JSON.stringify(roles, undefined, 2)}</pre> */}
                    ...
                    <div className="card">
                      ...
                      <Card.Body>
                        ...
                        <div className="mb-4">
                          ...
                          {/* <pre>{JSON.stringify(roles, undefined, 4)}</pre> */}
                          <select
                            className={`form-select ${
                          ...
                          {/* <Select
                            ...
                            onChange={(selectedOptions: any) => {
                              ...
                              setData("user_role", option.value);
                            }}
