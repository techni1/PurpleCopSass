...
import { Card, Container, Form, Modal, Row, Col } from "react-bootstrap";
...
const MonthGrid = () => {
  ...
  const { events, categories, isEventUpdated }: any = useSelector(
                    ...
                    <Card.Body>
                      <FullCalendar
                        ...
                        headerToolbar={{
                          ...
                          center: "title",
                          right:
                            "multiMonthYear,dayGridWeek,dayGridDay,listWeek",
                        }}
                        events={events}
                        editable={true}
                        droppable={true}
