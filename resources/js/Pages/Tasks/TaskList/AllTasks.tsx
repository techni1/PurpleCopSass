              ...
              <div className="flex-shrink-0 ms-4">
                <ul className="list-inline tasks-list-menu mb-0">
                  <li className="list-inline-item">
                    <Button variant='link' href="/apps-tasks-details" className='p-0'>
                      <i className="ri-eye-fill align-bottom me-2 text-muted"></i>
                    </Button>
                  </li>
                  <li className="list-inline-item">
                    <Button variant='link' href="#" onClick={() => { const taskData = cellProps.row.original; handleCustomerClick(taskData); }} className='p-0'>
                      <i className="ri-pencil-fill align-bottom me-2 text-muted"></i>
                    </Button>
                  </li>
                  <li className="list-inline-item">
                    <Button variant='link' href="#" className="remove-item-btn p-0" onClick={() => { const taskData = cellProps.row.original; onClickDelete(taskData); }}>
