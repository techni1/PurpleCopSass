                                ...
                                <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                    <div className="d-flex mb-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-13 text-body"><Link href="/pages-profile" >Joseph Parker</Link> <small className="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                            ...
                                            <div className="d-flex mt-4">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h5 className="fs-13 text-body"><Link href="/pages-profile" >Tonya Noble</Link> <small className="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                    ...
                                    <div className="d-flex mb-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-13 text-body"><Link href="/pages-profile" >Thomas Taylor</Link> <small className="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-13 text-body"><Link href="/pages-profile" >Tonya Noble</Link> <small className="text-muted">26 min ago</small></h5>
                                            ...
                                            <div className="d-flex mt-4">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h5 className="fs-13 text-body"><Link href="/pages-profile" >Nancy Martino</Link> <small className="text-muted">8 sec ago</small></h5>
