...
const TasksKanban = () => {
  ...
  const selectKanbanState = (state: any) => state.Tasks;
  ...
  const { tasks, loading }: any = useSelector(TasksKanbanProperties)
  ...
  return (
    <React.Fragment>
          ...
          <Row className="g-2">
            ...
            <div className="col-lg-3 col-auto">
              <div className="search-box">
                <Form.Control type="text" className="form-control search" id="search-task-options" placeholder="Search for project, tasks..." />
                <i className="ri-search-line search-icon"></i>
              </div>
            </div>
            <div className="col-auto ms-sm-auto">
              <div className="avatar-group" id="newMembar">
                {(headData || []).map((item: any, key: any) => (<Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" key={key} data-bs-trigger="hover" data-bs-placement="top" aria-label={item.name} data-bs-original-title={item.name}>
                  <img src={item.picture} alt="" className="rounded-circle avatar-xs" />
                </Link>))}
                <Link href="#addmemberModal" data-bs-toggle="modal" className="avatar-group-item" >
                  ...
                  <div className="tasks-list" key={line.id}>
                    <div className="d-flex mb-3">
                      ...
                      <div className="flex-shrink-0">
                        <Dropdown className="card-header-dropdown float-end">
                          <Dropdown.Toggle
                                  ...
                                  >
                                    {(provided: any) => (
                                      <div
                                        ...
                                        id={line.name + "-task"}
                                      >
                                        <div className="card task-box card-bg-fill" id="uptask-1">
                                          <CardBody>
                                            <Link href="#" className="text-muted fw-medium fs-14 flex-grow-1 ">{card.cardId}</Link>
                                                ...
                                                <div className="flex-shrink-0">
                                                  <div className="avatar-group">
                                                    {card.userImages.map((picturedata: any, idx: any) => (
                                                      <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Alexis" key={idx}>
                                              ...
                                              <div className="flex-shrink-0">
                                                <ul className="link-inline mb-0">
                                                  <li className="list-inline-item">
                                                    <Link href="#" className="text-muted"><i className="ri-eye-line align-bottom"></i> {card.eye}</Link>
                                                  </li>
                                                  <li className="list-inline-item">
                                                    <Link href="#" className="text-muted"><i className="ri-question-answer-line align-bottom"></i> {card.que}</Link>
                                                  </li>
                                                  <li className="list-inline-item">
                                                    <Link href="#" className="text-muted"><i className="ri-attachment-2 align-bottom"></i> {card.clip}</Link>
                                                  </li>
                                                </ul>
                                              </div>
                                            </div>
      ...
      {/* Create Modal */}
      <Modal show={modall} onHide={handleOpen} centered={true}>
        <div className="modal-content border-0" >
          ...
          <Modal.Body>
            <Form onSubmit={(event: any) => {
              ...
              <Row>
                <Col lg={12}>
                  <Form.Label htmlFor="boardName" className="form-label">Board Name</Form.Label>
                  <Form.Control type="text" id="boardName" placeholder="Enter board name"
      ...
      <Modal id="modalForm" show={modal} onHide={toggle} centered={true} size="lg">
        ...
        <Modal.Body>
          ...
          >
            <div className="form-group mb-3">
              <Form.Label htmlFor="taskname" className="col-form-label">
            ...
            <div className="form-group mb-3">
              <Form.Label className="col-form-label">Task Description</Form.Label>
              <Col lg={12}>
                <textarea
                  id="text"
                      ...
                      <li key={index}>
                        <div className="form-check form-check-primary mb-2 d-flex align-items-center">
                          <Form.Check.Input
                            ...
                            checked={isChecked}
                          />
                          <Form.Check.Label className="form-check-label ms-2" htmlFor={"member" + image.id}>
                            {image.name}
                          </Form.Check.Label>
                          <img
                            src={image.img}
            ...
            <div className="form-group mb-4">
              ...
              {validation.errors.botId && validation.touched.botId ? (
                <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.botId}</Form.Control.Feedback>
              ) : null}
            </div>
            {/* Bottom */}
            <div className="form-group mb-4 d-flex">
              <div>
                <Form.Label htmlFor="eyefor" className="col-form-label">
                  View
                </Form.Label>
                <Col lg={4}>
                  <Form.Control
              ...
              <div>
                <Form.Label htmlFor="quefor" className="col-form-label">
                  Comment
                </Form.Label>
                <Col lg={4}>
                  <Form.Control
              ...
              <div>
                <Form.Label htmlFor="clipfor" className="col-form-label">
                  Pinned
                </Form.Label>
                <Col lg={4}>
                  <Form.Control
