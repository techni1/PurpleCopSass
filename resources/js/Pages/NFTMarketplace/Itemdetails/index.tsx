                  ...
                  <div>
                    <Dropdown className="float-end">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end">
                        <Dropdown.Item href="#" className="view-item-btn">
                    ...
                    <span className="badge bg-primary-subtle text-primary mb-3 fs-12">
                    ...
                    <div className="product-content mt-5">
                      ...
                      <Tab.Container defaultActiveKey="1">
                        <Nav className="nav-tabs-custom nav-primary">
                          <Nav.Item>
                            <Nav.Link eventKey="1">Place Bids</Nav.Link>
                          </Nav.Item>
                          <Nav.Item>
                            <Nav.Link eventKey="2">
                          ...
                          <Nav.Item>
                            <Nav.Link eventKey="3">Details</Nav.Link>
                          </Nav.Item>
                        </Nav>
                        <Tab.Content className="border border-top-0 p-4">
                          <Tab.Pane id="nav-speci" eventKey="1">
                          ...
                          <Tab.Pane id="nav-detail" eventKey="2">
                            <div className="table-responsive">
                          ...
                          <Tab.Pane id="nav-detail" eventKey="3">
                            <div>
                              ...
                              <p>
                                ...
                                practices that are steady over time. In art, a
                                pattern is a repetition of specific visual
