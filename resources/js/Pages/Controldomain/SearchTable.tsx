...
const SearchTable = ({ routeTo, tableData, index = 0 }: any) => {
  ...
  const handleDeleteClick = (controldomain: any) => {
    setModalTitle("Are You Sure");
    setModalMessage(`Control Domain ${controldomain.name} will be deleted !!`);
    setDesignationToDelete(controldomain);
    setShowModal(true);
  };
  ...
  const deleteClient = () => {
    router.delete(route("controldomain.destroy", designationToDelete));
    setShowModal(false);
  };
