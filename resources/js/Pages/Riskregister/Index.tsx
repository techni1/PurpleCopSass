...
export default function Index({ auth, risks, assets, success }: any) {
  ...
  return (
    <React.Fragment>
      <Head title="Risk Management - Register" />

      <div className="page-content">
        <Container fluid>
          {/* <pre>{JSON.stringify(risks, undefined, 2)}</pre> */}
          <BreadCrumb title="Risk Management" pageTitle="Dashboard" />
          <Row>
            <Col>
              <div className="h-100">
                <Section adata={assets} />
              </div>
            </Col>
          </Row>
          {success && (
