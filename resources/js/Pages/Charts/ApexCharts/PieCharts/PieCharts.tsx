...
const SimplePie = ({ dataColors, data }: any) => {
  ...
  var options: any = {
    ...
    labels: ["Under Training", "Training Done", "Non Personnel"],
    legend: {
      position: "bottom",
    },
    dataLabels: {
...
const SimpleDonut = ({ dataColors }: any) => {
  ...
  const series = [30, 40, 35]; // This represents the data points for each risk
  ...
  var options: any = {
    ...
    labels: ["Medium", "Low", "High"], // Define the labels for the donut chart
  };
