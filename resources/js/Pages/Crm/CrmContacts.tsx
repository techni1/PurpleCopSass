...
const CrmContacts = () => {
  ...
  const crmcontactData = createSelector(selectContactState, (state: any) => ({
    crmcontacts: state.crmcontacts,
    error: state.error,
  }));
  // Inside your component
  const { crmcontacts, error }: any = useSelector(crmcontactData);
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            href="#"
                            className="btn btn-soft-secondary arrow-none"
                            as="button"
                          >
