    ...
    <React.Fragment>
                ...
                <div className="col-md-auto ms-auto">
                  <div className="d-flex hastck gap-2 flex-wrap">
                    ...
                    <Dropdown>
                      <Dropdown.Toggle
                        href="#"
                        className="btn btn-soft-secondary btn-icon fs-14 arrow-none"
                        as="button"
                      >
      ...
      <Modal id="adddeals" show={modal} onHide={toggle} centered>
        <Modal.Header className="bg-light p-3" closeButton>
          <h5 className="modal-title">Create Deals</h5>
        </Modal.Header>
        <Form
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <Modal.Body>
            <div className="mb-3">
              <Form.Label htmlFor="deatType" className="form-label">
                Deals Type
              </Form.Label>
              <select
            ...
            <div className="mb-3">
              <Form.Label htmlFor="dealTitle" className="form-label">
                Deal Title
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="dealValue" className="form-label">
                Value (USD)
              </Form.Label>
              <Form.Control
                type="number"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="dealOwner" className="form-label">
                Deals Owner
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="dueDate" className="form-label">
                Due Date
              </Form.Label>
              <Flatpickr
                name="date"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="dealEmail" className="form-label">
                Email
              </Form.Label>
              <Form.Control
                type="email"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="contactNumber" className="form-label">
                Contact
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="contactDescription" className="form-label">
                Description
              </Form.Label>
              <textarea
                className="form-control"
