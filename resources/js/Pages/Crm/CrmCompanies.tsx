...
const CrmCompanies = () => {
  ...
  const crmcompaniesData = createSelector(selectCRMState, (state: any) => ({
    companies: state.companies,
    isCompaniesSuccess: state.isCompaniesSuccess,
    error: state.error,
  }));
  // Inside your component
  const { companies, error }: any = useSelector(crmcompaniesData);
                    ...
                    >
                      ...
                      <Modal.Footer>
                        <div className="hstack gap-2 justify-content-end">
                          ...
                          <Button type="submit" variant="success" id="add-btn">
                            {" "}
