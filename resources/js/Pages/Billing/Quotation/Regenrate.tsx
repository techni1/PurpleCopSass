...
export default function Regenrate({ show, setShow, billing, mastersetting, organization, entity, packagedata, offers, framwork, bank }: any) {
    ...
    useEffect(() => {
        if (billing) {
            setData({
                ...
                invoice_date: billing.invoice_date || new Date().toISOString().split('T')[0],
                invoice_due_date: billing.invoice_due_date || "",
                ponumber: billing.ponumber || "",
                payment_term: billing.payment_term || "",
                notes: billing.notes || "",

                items: Array.isArray(billing.item_desc)
                    ? billing.item_desc
                    : [
    ...
    const onSubmit = (e: any) => {
        e.preventDefault();
        post(route("billing.regenrate", billing.id), {
            preserveScroll: true,
            onSuccess: () => {
                            ...
                            <Card.Body>
                                ...
                                <div className="col-md-12">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <h6>Sub Total Amount: ${Number(data.finalAmount || 0).toFixed(2)}</h6>
                                        ...
                                        <div className="col-md-6"></div>
                                        <div className="col-md-6">
                                            <h5>Billing Amount: ${Number(data.billingAmount || 0).toFixed(2)}</h5>
                                        </div>
