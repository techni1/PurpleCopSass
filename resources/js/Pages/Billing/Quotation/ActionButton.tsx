    ...
    const handleCloseModal = () => {
     ...
     const moveBilling = (selectedBillingid: any) => {
        if (selectedBillingid) {
          router.post(route("quotation.movetobilling", { id: selectedBillingid}), {}, {
            onSuccess: () => {
              router.reload();
            }
          });
  ...
  <Modal show={showBilling} onHide={handleCloseModal} centered>
        ...
        <Modal.Body className="text-center p-5">
          ...
          <div className="mt-4">
            ...
            <p className="text-muted mb-4"> You want to convert this Quotation to Billing process {selectedBillingid}</p>
            <div className="hstack gap-2 justify-content-center">
              <Button variant="light" onClick={handleCloseModal}>
                Close
              </Button>

              <Button variant="danger" onClick={(e) => moveBilling(selectedBillingid)}>
                Confirm
              </Button>
            </div>
          </div>
