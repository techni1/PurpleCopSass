              ...
              <Card.Body>
                <div className="col-md-12">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <Form.Label htmlFor="bank_details" className="form-label">
                    ...
                    <div className="col-md-6">
                      <Form.Label htmlFor="paymentnotes" className="form-label">
                        Payment Notes
                      </Form.Label>
                    ...
                    <div className="col-md-6">
                      <Form.Label htmlFor="packageid" className="form-label">
                    ...
                    <div className="col-md-6">
                      ...
                      <h6>
                        Package Amount: ${Number(data.packageaddon).toFixed(2)}
                      </h6>
