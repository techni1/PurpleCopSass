...
export default function AddBilling({
  ...
  const handleDiscountRateChange = (
    ...
    const discountAmount = parseFloat(
      e.target.selectedOptions[0].getAttribute("data-discount") || "0"
    ...
    setData((prevData) => {
      ...
      updateFinalAndBillingAmount(
        updatedData.items,
        updatedData.taxRate,
        discountAmount,
        updatedData.packageAmount
      );
      return updatedData;
    });
  };
  ...
  const handlePackageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const packageAmount = parseFloat(
      e.target.selectedOptions[0].getAttribute("data-package") || "0"
    ); // Fetch discount amount
  ...
  const handleTaxRateChange = (value: string) => {
    ...
    setData((prevData) => {
      ...
      updateFinalAndBillingAmount(
        ...
        updatedData.discountAmount,
        updatedData.packageAmount
      ); // Use updated state for recalculations
      return updatedData;
    });
  };

  const updateFinalAndBillingAmount = (
    items: any[],
    taxRate: number,
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <select
                        ...
                        } // Update the selected entity in state
                      >
                    ...
                    <div className="col-md-4">
                      ...
                      <Form.Control
                        ...
                        className={
                          "form-control" +
                          (errors.invoce_no ? " is-invalid" : "")
                        }
                        onChange={(e: any) =>
                          setData("invoce_no", e.target.value)
                        }
                        required
                      />
                      <Form.Control.Feedback
                    ...
                    <div className="col-md-4">
                      <Form.Label htmlFor="invoice_date" className="form-label">
                    ...
                    <div className="col-md-4">
                      ...
                      <Form.Control
                        ...
                        className={
                          "form-control" +
                          (errors.invoice_due_date ? " is-invalid" : "")
                        }
                        onChange={(e: any) =>
                          setData("invoice_due_date", e.target.value)
                        }
                        required
                      />
                      <Form.Control.Feedback
                    ...
                    <div className="col-md-4">
                      <Form.Label htmlFor="ponumber" className="form-label">
                    ...
                    <div className="col-md-4">
                      <Form.Label htmlFor="payment_term" className="form-label">
                      ...
                      <Form.Control
                        ...
                        className={
                          "form-control" +
                          (errors.payment_term ? " is-invalid" : "")
                        }
                        onChange={(e: any) =>
                          setData("payment_term", e.target.value)
                        }
                        required
                      />
                      <Form.Control.Feedback
                    ...
                    <div className="col-md-12">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              {bank.map((odata: any) => (
                                <option key={odata.id} value={odata.id}>
                                  {odata.bank_accountname} -{" "}
                                  {odata.bank_accountno}
                                </option>
                              ))}
                            </select>
                          ...
                          <div className="col-md-12">
                            ...
                            <Textarea
                              ...
                              onChange={(e: any) =>
                                setData("paymentnotes", e.target.value)
                              }
                            ></Textarea>
                            <Form.Control.Feedback
                              type="invalid"
                        ...
                        <div className="col-md-6">
                          <div className="col-md-12">
                            <h6>
                              Sub Total Amount: ${data.finalAmount.toFixed(2)}
                            </h6>
                          </div>
                          <div className="col-md-12">
                            <Form.Label
                            ...
                            >
                              ...
                              {packagedata.map((pdata: any) => (
                                <option
                                  value={pdata.id}
                                  data-package={pdata.package_amount}
                                >
                                  {pdata.name} - {pdata.package_amount}
                                </option>
                              ))}
                            </select>
                          ...
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              {offers.map((offdata: any) => (
                                <option
                                  value={offdata.id}
                                  data-discount={offdata.percentage}
                                >
                                  {offdata.name} - {offdata.percentage}%
                                </option>
                              ))}
                            </select>
                          ...
                          <div className="col-md-12">
                            ...
                            <h6>
                              Package Amount: $
                              {Number(data.packageaddon).toFixed(2)}
                            </h6>
                            <h6>
                              Tax Amount: ${Number(data.taxAmount).toFixed(2)}
                            </h6>
                          </div>

                          <div className="col-md-12">
                            <h5>
                              Billing Amount: ${data.billingAmount.toFixed(2)}
                            </h5>
                          </div>
                        </div>
                      </div>
