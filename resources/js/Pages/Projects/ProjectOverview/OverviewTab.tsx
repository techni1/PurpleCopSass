    ...
    <React.Fragment>
      <Row>
                          ...
                          <div className="flex-shrink-0 ms-2">
                            <div className="d-flex gap-1">
                              ...
                              <Dropdown>
                                <Dropdown.Toggle
                                  as="button"
                                  className="btn btn-icon text-muted btn-sm fs-18 dropdown arrow-none"
                                >
            ...
            <Card.Header className="align-items-center d-flex">
              ...
              <div className="flex-shrink-0">
                <Dropdown className="card-header-dropdown">
                  <Dropdown.Toggle
                    as="a"
                    className="arrow-none text-reset dropdown-btn"
                    href="#"
                  >
                  ...
                  <Dropdown.Menu className="dropdown-menu-end">
                    ...
                    <Dropdown.Item>Previous</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            </Card.Header>
              ...
              <form className="mt-4">
                <Row className="g-3">
                  ...
                  <Col xs={12} className="text-end">
                    <button
                      type="button"
                      className="btn btn-ghost-primary btn-icon waves-effect me-1"
                    >
        ...
        <Col xl={3} lg={4}>
          <Card>
            <Card.Body>
              ...
              <div className="d-flex flex-wrap gap-2 fs-16">
                <div className="badge fw-medium bg-primary-subtle text-primary">
                  UI/UX
                </div>
                <div className="badge fw-medium bg-primary-subtle text-primary">
                  Figma
          ...
          <Card>
            <Card.Header className="align-items-center d-flex border-bottom-dashed">
                    ...
                    <div className="flex-shrink-0">
                      <div className="d-flex align-items-center gap-1">
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            type="button"
                            className="arrow-none btn btn-icon btn-sm fs-16 text-muted dropdown"
                            as="button"
                          >
                            <i className="ri-more-fill"></i>
                          </Dropdown.Toggle>
                    ...
                    <div className="flex-shrink-0 ms-2">
                      <div className="d-flex gap-1">
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            as="button"
                            className="arrow-none btn btn-icon text-muted btn-sm fs-18 dropdown"
                            type="button"
                          >
                            <i className="ri-more-fill"></i>
                          </Dropdown.Toggle>
