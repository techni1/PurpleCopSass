                    ...
                    <div className="acitivity-timeline py-3">
                        ...
                        <div className="acitivity-item py-3 d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                                ...
                                <div className="avatar-group mb-2">
                                    <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                        <img src={avatar4} alt="" className="rounded-circle avatar-xs" />
                                    </Link>
                                    <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                        <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                    </Link>
                                    <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title=" Ruby">
                                    ...
                                    <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="more">
                                        <div className="avatar-xs">
                        ...
                        <div className="acitivity-item py-3 d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                                ...
                                notification to submit the monthly sales report. <Link href="#" className="link-warning text-decoration-underline">Reports Builder</Link></p>
