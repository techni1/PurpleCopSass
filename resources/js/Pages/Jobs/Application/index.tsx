...
import {
  onaddNewJobApplicationList,
  ondeleteJobApplicationList,
  ongetApplicationList,
  onupdateJobApplicationList,
        ...
        cell: (appList: any) => (
          <>
            <div className="d-flex align-items-center">
              ...
              <div className="flex-grow-1 ms-2 ">{appList.getValue()}</div>
            </div>
          </>
        ),
      },
            ...
            <div className="d-flex gap-3">
              ...
              >
                ...
                >
                  <Button
                    variant="link"
                    className="p-0 text-primary d-inline-block p-0 btn-sucess"
                  >
