                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Badge bg="dark" className="text-body" pill>
                        {" "}
                        Dark{" "}
                      </Badge>
                      <Badge bg="light" className="text-body" pill>
                        {" "}
                        Light{" "}
                      </Badge>
                    </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Badge bg="primary" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Primary{" "}
                      </Badge>
                      <Badge bg="secondary" className="badge-label">
                        {" "}
                      ...
                      <Badge bg="danger" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Danger{" "}
                      </Badge>
                      <Badge bg="warning" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Warning{" "}
                      </Badge>
                      <Badge bg="info" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Info{" "}
                      </Badge>
                      <Badge bg="dark" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Dark{" "}
                      </Badge>
                      <Badge bg="light" className="badge-label text-body">
                        {" "}
