                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-3">
                      <Dropdown>
                        <Dropdown.Toggle
                          as="button"
                          className="arrow-none btn btn-secondary"
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>divider</code> attribute to Dropdown.Item to
                            ...
                            <div className="dropdown-head bg-primary bg-pattern rounded-top">
                              ...
                              <div className="px-2 pt-2">
                                <Nav className="dropdown-tabs nav-tabs-custom">
                                  <Nav.Item>
                                    <Nav.Link eventKey="1">All (4)</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
                                    <Nav.Link eventKey="2">Messages</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
                                    <Nav.Link eventKey="3">Alerts</Nav.Link>
                                  </Nav.Item>
                                </Nav>
                              </div>
                            </div>
                          ...
                          <Tab.Container defaultActiveKey="7">
                            <div className="dropdown-head bg-secondary bg-pattern rounded-top">
                              ...
                              <div className="px-2 pt-2">
                                <Nav className="dropdown-tabs nav-tabs-custom">
                                  <Nav.Item>
                                    <Nav.Link eventKey="7">All (4)</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
                                    <Nav.Link eventKey="8">Messages</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
                                    <Nav.Link eventKey="9">Alerts</Nav.Link>
                                  </Nav.Item>
                                </Nav>
                              </div>
                            </div>
