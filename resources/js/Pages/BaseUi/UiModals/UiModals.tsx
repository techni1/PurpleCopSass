...
const UiModals = () => {
  ...
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div>
                      <Button variant="primary" onClick={() => tog_standard()}>
                        Standard Modal
                      </Button>
                    </div>
                  </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div>
                      <Button variant="primary" onClick={() => tog_center()}>
                        Center Modal
                      </Button>
                    </div>
                  </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <Card.Body>
                  <div className="live-preview">
                    <div>
                      <Button variant="primary" onClick={() => tog_togFirst()}>
                        Open First Modal
                      </Button>
                    </div>
                  </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <Card.Body>
                  <div className="live-preview">
                    <div>
                      <Button variant="primary" onClick={() => tog_scroll()}>
                        Scrollable Modal
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="live-preview">
                    <div>
                      <div className="hstack gap-2 flex-wrap">
                        ...
                        <Button
                          variant="primary"
                          onClick={() => tog_varying2()}
                        >
                          Open Modal for Jennifer
                        </Button>
                        <Button
                          variant="primary"
                          onClick={() => tog_varying3()}
                        >
                  ...
                  <div className="live-preview">
                    <div>
                      <div className="hstack flex-wrap gap-2">
                        ...
                        {/* 
                                                // <!-- Extra Large modal --> */}
                        <Button variant="info" onClick={() => tog_xlarge()}>
                          Extra large Modal
                        </Button>

                        {/* 
                                                // <!-- Large modal --> */}
                        <Button variant="success" onClick={() => tog_large()}>
                          Large Modal
                        </Button>

                        {/* 
                                                // <!-- Small modal --> */}
                        <Button variant="danger" onClick={() => tog_small()}>
                          Small Modal
                        </Button>
                      </div>
                    </div>
      ...
      {/* Vertically Centered */}
      <Modal show={modal_center} onHide={tog_center} centered>
        ...
        <Modal.Body className="text-center p-5">
          ...
          <div className="mt-4">
            ...
            <div className="hstack gap-2 justify-content-center">
              <Button variant="light" onClick={tog_center}>
                Close
              </Button>
      ...
      {/* Grids in Modals */}
      <Modal show={modal_grid} onHide={tog_grid}>
        <Modal.Header closeButton>
            ...
            <div className="row g-3">
              ...
              <Col lg={12}>
                <div className="hstack gap-2 justify-content-end">
                  <Button variant="light" onClick={tog_grid}>
                    Close
                  </Button>
        ...
        <Modal.Body className="text-center p-5">
          ...
          <div className="mt-4">
            ...
            <div className="hstack gap-2 justify-content-center">
              ...
              <Link href="#" className="btn btn-success" onClick={tog_backdrop}>
                Completed
              </Link>
            </div>
          </div>
        ...
        <Modal.Body className="text-center p-5">
          ...
          <div className="mt-4 pt-3">
            ...
            <div className="hstack gap-2 justify-content-center">
              ...
              <Button variant="light" onClick={tog_togSecond}>
                Close
              </Button>
            </div>
          </div>
      ...
      <Modal show={modal_tooltip} onHide={tog_tooltip}>
        ...
        <Modal.Body>
          ...
          <p className="text-muted">
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="tooltip-top"> graphic design </Tooltip>}
            >
              <Link
                href="#"
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="tooltip-top"> design </Tooltip>}
            >
              <Link
                href="#"
      ...
      >
        ...
        <Modal.Footer>
          <Button variant="light" onClick={tog_scroll}>
            Close
          </Button>
          <Button variant="primary">Save changes</Button>
        </Modal.Footer>
      ...
      {/* Extra Large Modal */}
      <Modal size="xl" show={modal_xlarge} onHide={tog_xlarge}>
        <Modal.Header closeButton>
      ...
      {/* Large Modal */}
      <Modal size="lg" show={modal_large} onHide={tog_large}>
        <Modal.Header closeButton>
          {" "}
      ...
      {/* Small Modal */}
      <Modal size="sm" show={modal_small} onHide={tog_small}>
        <Modal.Header closeButton>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>New message to Mary</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form>
            <div className="mb-3">
              <Form.Label htmlFor="customer-name" className="col-form-label">
                Customer Name:
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="message-text" className="col-form-label">
                Message:
              </Form.Label>
              <textarea
                className="form-control"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>New message to Jennifer</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form>
            <div className="mb-3">
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>New message to Roderick</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form>
            <div className="mb-3">
      ...
      <Modal
        ...
        show={modal_positionBottomRight}
        onHide={() => {
