...
const UiAccordions = () => {
  ...
  const [multiCollapseExample1, setMultiCollapseExample1] =
    useState<boolean>(true);
  const [multiCollapseExample2, setMultiCollapseExample2] =
    useState<boolean>(true);
                  ...
                  <div className="live-preview">
                    <div className="hstack gap-3 mb-3">
                      <Button
                        ...
                        type="button"
                        onClick={() => setCollapseWithicon(!collapseWithicon)}
                      >
                      ...
                      <Button
                        variant="light"
                        type="button"
                        onClick={() => setCollapseWithicon2(!collapseWithicon2)}
                      >
                  ...
                  <div className="live-preview">
                    <div className="mb-3">
                      <h6
                        ...
                        onClick={() => setCollapseblock(!collapseblock)}
                      >
                      ...
                      <span
                        ...
                        aria-expanded={collapseinline}
                        aria-controls="collapseinline"
                        onClick={() => setCollapseinline(!collapseinline)}
                      >
                        ...
                        <Collapse dimension="width" in={collapseinline}>
                          <div id="collapseinline">
                            <Card
                              ...
                              style={{ width: "300px" }}
                            >
                              When you have created a new account schedule and
                              set up the rows, you must set up columns.
                            </Card>
                          </div>
                        </Collapse>
                      </Col>
                  ...
                  <div className="live-preview">
                    <div className="d-flex gap-2 flex-wrap mb-3">
                      <a
                        ...
                        onClick={() =>
                          setMultiCollapseExample1(!multiCollapseExample1)
                        }
                      >
                      ...
                      <Button
                        variant="primary"
                        onClick={() =>
                          setMultiCollapseExample2(!multiCollapseExample2)
                        }
                      >
