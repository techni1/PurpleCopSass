          ...
          <Row>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>as="a"</code> to create actionable list group
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>as="button"</code> to create actionable list group
                    items with hover, disabled, and active states by adding
                    list-group-item-action.
                  </p>
                  <div className="live-preview">
          ...
          <Row>
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>variant="Required color"</code> to style list
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>as="a" href="#"</code> to add link. Note the
