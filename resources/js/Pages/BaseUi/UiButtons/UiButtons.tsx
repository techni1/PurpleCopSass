                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <button className="btn btn-soft-secondary waves-effect waves-light">
                        {" "}
                        Secondary{" "}
                      </button>
                      <button className="btn btn-soft-success waves-effect waves-light">
                        {" "}
                        Success{" "}
                      </button>
                      <button className="btn btn-soft-info waves-effect waves-light">
                        {" "}
                        Info{" "}
                      </button>
                      <button className="btn btn-soft-warning waves-effect waves-light">
                        {" "}
                        Warning{" "}
                      </button>
                      <button className="btn btn-soft-danger waves-effect waves-light">
                        {" "}
                        Danger{" "}
                      </button>
                      <button className="btn btn-soft-dark waves-effect waves-light">
                        {" "}
                        Dark{" "}
                      </button>
                    </div>
                    ...
                    <Row>
                      <Col lg={4}>
                        <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                          <Button variant="primary" className="btn-label">
                            {" "}
                      ...
                      <Col lg={4}>
                        <div className="d-flex flex-wrap gap-2">
                          <Button variant="primary" className="btn-label right">
                            {" "}
                    ...
                    <Row>
                      <Col lg={6}>
                        <div className="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                          ...
                          <Button variant="secondary" className="btn-border">
                            Secondary
                          </Button>
                          <Button variant="success" className="btn-border">
                            Success
                          </Button>
                          <Button variant="warning" className="btn-border">
                            Warning
                          </Button>
                          <Button variant="danger" className="btn-border">
                            Danger
                          </Button>
                        </div>
                      </Col>
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Button variant="danger" className="w-sm">
                        {" "}
                        Small{" "}
                      </Button>
                      <Button variant="warning" className="w-md">
                        {" "}
                        Medium{" "}
                      </Button>
                      <Button variant="success" className="w-lg">
                        {" "}
                        Large{" "}
                      </Button>
                    </div>
