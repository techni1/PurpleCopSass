...
const UiOffcanvas = () => {
  ...
  return (
    <React.Fragment>
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Button variant="primary" onClick={toggleTopCanvas}>
                        Toggle Top Offcanvas
                      </Button>
                      <Button variant="secondary" onClick={toggleRightCanvas}>
                        Toggle Right Offcanvas
                      </Button>
                      <Button variant="success" onClick={toggleBottomCanvas}>
                        Toggle Bottom Offcanvas
                      </Button>
                      <Button variant="danger" onClick={toggleLeftCanvas}>
            ...
            <div className="acitivity-timeline p-4">
              ...
              <div className="acitivity-item py-3 d-flex">
                ...
                <div className="flex-grow-1 ms-3">
                  ...
                  <p className="text-muted mb-2">
                    added a new member to Judia dashboard
                  </p>
      ...
      >
        <Offcanvas.Header closeButton className="border-bottom">
          <Offcanvas.Title id="offcanvasLeftLabel">
            Recent Acitivity
          </Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
