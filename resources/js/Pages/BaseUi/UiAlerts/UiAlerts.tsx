...
const UiAlerts = () => {
  const [liveAlertPlaceholder, setLiveAlertPlaceholder] =
    useState<boolean>(false);
  const alert: AlertProps[] = [
    {
      variant: "primary",
      name: "Primary",
      discription: ` <strong> Hi! </strong> A simple <b>Dismissible Primary alert</b> —check it out!`,
    },
    {
      variant: "secondary",
      name: "Secondary",
      discription: ` <strong> How are you! </strong> A simple <b>Dismissible secondary alert</b> —check it out!`,
    },
    {
      variant: "success",
      name: "Success",
      discription: `<strong> Yey! Everything worked! </strong> A simple <b>Dismissible success alert</b> —check it out!`,
    },
    {
      variant: "danger",
      name: "Danger",
      discription: ` <strong> Something is very wrong! </strong> A simple <b>Dismissible danger alert</b> —check it out!`,
    },
    {
      variant: "warning",
      name: "Warning",
      discription: ` <strong> Uh oh, something went wrong </strong> A simple <b>Dismissible warning alert</b> —check it out!`,
    },
    {
      variant: "info",
      name: "Info",
      discription: ` <strong>Don't forget' it !</strong> A simple <b>Dismissible info alert</b> —check it out!`,
    },
    {
      variant: "light",
      name: "Light",
      discription: `<strong>Mind Your Step!</strong> A simple <b>Dismissible light alert</b> —check it out!`,
    },
    {
      variant: "dark",
      name: "Dark",
      discription: ` <strong>Did you know?</strong> A simple <b>Dismissible dark alert</b> —check it out!`,
    },
  ];
  return (
    <React.Fragment>
                  ...
                  <div className="live-preview">
                    <Row>
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="light"
                          className="border-0 border-0 bg-light"
                        >
                          <strong>Mind Your Step!</strong> A simple{" "}
                          <b>light alert</b> —check it out!
                        </Alert>
                        ...
                        <Alert
                          variant="dark"
                          className="border-0 border-0 mb-0"
                        >
                          <strong>Did you know?</strong> A simple{" "}
                          <b>dark alert</b> —check it out!
                        </Alert>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        {(alert || [])
                          .slice(0, 4)
                          .map((value: AlertProps, inx: number) => (
                ...
                <Card.Body>
                  ...
                  <div className="live-preview">
                    <div id="liveAlertPlaceholder">
                      <Alert
                        show={liveAlertPlaceholder}
                        variant="success"
                        onClose={() =>
                          setLiveAlertPlaceholder(!liveAlertPlaceholder)
                        }
                        dismissible
                      >
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="danger"
                          className="bg-body-secondary mb-xl-0"
                          role="alert"
                          dismissible
                        >
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="dark"
                          className="text-body bg-body-secondary mb-0"
                          role="alert"
                          dismissible
                        >
                    ...
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-check-double-line me-3 align-middle fs-lg"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-notification-off-line me-3 align-middle fs-lg"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-error-warning-line me-3 align-middle fs-lg"></i>
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-alert-line me-3 align-middle fs-lg"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-airplay-line me-3 align-middle fs-lg"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-mail-line me-3 align-middle fs-lg"></i>
                        ...
                        <Alert
                          variant="dark"
                          className="text-body alert-border-left mb-0"
                          role="alert"
                          dismissible
                        >
                          <i className="ri-refresh-line me-3 align-middle fs-lg"></i>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="primary"
                          className="text-white bg-primary alert-label-icon"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                        ...
                        <Alert
                          variant="success"
                          className="text-white bg-success alert-label-icon"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                        ...
                        <Alert
                          variant="danger"
                          className="text-white bg-danger alert-label-icon mb-xl-0"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="warning"
                          className="text-white bg-warning alert-label-icon"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                        ...
                        <Alert
                          variant="info"
                          className="text-white bg-info alert-label-icon"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                        ...
                        <Alert
                          variant="light"
                          className="text-body bg-light alert-label-icon"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                        ...
                        <Alert
                          variant="dark"
                          className="text-white bg-dark alert-label-icon mb-0"
                          role="alert"
                          closeVariant="white"
                          dismissible
                        >
                    ...
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-primary ri-user-smile-line label-icon"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-secondary ri-check-double-line label-icon"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-success ri-notification-off-line label-icon"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-danger ri-error-warning-line label-icon"></i>
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-warning ri-alert-line label-icon"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-info ri-airplay-line label-icon"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="ri-mail-line me-3 align-middle fs-lg text-dark"></i>
                        ...
                        <Alert
                          ...
                          dismissible
                        >
                          <i className="me-3 align-middle fs-lg text-dark ri-refresh-line label-icon"></i>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="success"
                          className="alert-label-icon  -label"
                          role="alert"
                          dismissible
                        >
                          <i className="ri-notification-off-line label-icon"></i>
                        ...
                        <Alert
                          variant="danger"
                          className="alert-label-icon rounded-label mb-xl-0"
                          role="alert"
                          dismissible
                        >
                          <i className="ri-error-warning-line label-icon"></i>
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="dark"
                          className="alert-label-icon rounded-label mb-0"
                          role="alert"
                          dismissible
                        >
                          <i className="ri-refresh-line label-icon"></i>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="danger"
                          className="border-0 bg-danger text-white mb-xl-0"
                        >
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          variant="light"
                          className="border-0 bg-light text-white"
                        >
                        ...
                        <Alert
                          variant="dark"
                          className="border-0 bg-dark text-white mb-0"
                        >
