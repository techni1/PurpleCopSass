                ...
                <Card.Body>
                  ...
                  <Tab.Container defaultActiveKey="2">
                    <Nav className="nav-tabs nav-justified mb-3">
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="2">Product</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="3">Messages</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        ...
                        >
                            ...
                            <div className="d-flex mb-2">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  ...
                                  and play around with the fonts that you
                                  already have in the software you’re working
                          ...
                          <Tab.Pane eventKey="2" id="v-pills-profile">
                            <div className="d-flex mb-2">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  {" "}
                                  I also decreased the transparency in the text
                                  so that the mountains come through the text,
                                  bringing the quote truly to life. Make sure
                                  that the placement of your text is pleasing to
                                  look at, and you try to achieve symmetry for
                                  this effect.
                                </p>
                              </div>
                            </div>
                          ...
                          <Tab.Pane eventKey="3" id="v-pills-messages">
                            <div className="d-flex mb-2">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  In this image, you can see that the line
                                  height has been reduced significantly, and the
                                  size was brought up exponentially. Experiment
                                  and play around with the fonts that you
                                  already have in the software you’re working
                                  with reputable font websites.
                                </p>
                            ...
                            <p className="mb-0">
                              ...
                              overboard This may be the most commonly
                          ...
                          <Tab.Pane eventKey="4" id="v-pills-settings">
                            <div className="d-flex mb-2">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  ...
                                  attention and portray to them what you’re
                                  trying to say. You can make a big statement by
                                  using little tricks, like this one. Use
                                  contrasting fonts. you can use a bold sanserif
                                  font with a cursive.
                                </p>
                              </div>
                            </div>
                            <p className="mb-0">
                              ...
                              your principal object is larger than the others,
                              as the eye of your viewer will automatically be
                    ...
                    <Tab.Content className="text-muted">
                      <Tab.Pane eventKey="1" id="home2">
                        <p className="flex-grow-1 mb-0">
                          ...
                          shorts ullamco ad vinyl cillum PBR. Homo nostrud
                          organic, assumenda labore aesthetic magna delectus. If
                          you’re using multiple elements, make sure that your
                      ...
                      <Tab.Pane eventKey="2" id="profile2">
                        <p className="me-3 mb-0">
                          ...
                          magna delectus.commodo enim craft beer mlkshk aliquip
                          jean shorts ullamco ad vinyl cillum PBR. Homo nostrud
                          organic, assumenda labore aesthetic magna delectus
                          Scale all elements of your design: text, elements,
                          buttons, everything. Increase or decrease the letter
                      ...
                      <Tab.Pane eventKey="3" id="messages2">
                        <p className="ms-3 mb-0">
                          ...
                          sweater. Fanny pack portland seitan DIY, art party
                          locavore wolf cliche high life echo park Austin. Cred
                          vinyl keffiyeh DIY salvia PBR, beer mlkshk aliquip
                          jean shorts ullamco ad vinyl cillum PBR. Homo nostrud
                          organic, assumenda labore aes Homo nostrud organic,
                          assumenda labore aesthetic magna delectus Scale all
                          elements of your design: text, elements, buttons,
          ...
          <Row>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <Card.Body>
                  <p className="text-muted">
                    Use <code>arrow-navtabs </code>className to create arrow
                    nav.
                  </p>
                  <Tab.Container defaultActiveKey="1">
                    <Nav
                    ...
                    <Tab.Content className="text-muted">
                      <Tab.Pane eventKey="1" id="arrow-overview">
                        ...
                        <p className="mb-0">
                          ...
                          design is that it has become more and more popular
                          over the years, which is excellent news to the
                      ...
                      <Tab.Pane eventKey="2" id="arrow-profile">
                        ...
                        <p className="mb-0">
                          ...
                          nature to be interested in the unusual, and that’s why
                          using contrasting colors in{" "}
                          <Link href="#" className="text-decoration-underline">
                            <b>Graphic Design</b>
                          </Link>{" "}
                          is a must. It’s eye-catching, it makes a statement,
                          it’s impressive graphic design. Increase or decrease
                          the letter spacing depending on the situation and try,
                          try again until it looks right, and each letter has
                          the perfect spot of its own.
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="3" id="arrow-contact">
                        ...
                        <p className="mb-0">
                          ...
                          it is vital for people to begin put 2 and 2 together
                          and begin to recognize your cause. Consistency piques
                  ...
                  <div className="card-header align-items-xl-center d-xl-flex">
                    ...
                    <div className="flex-shrink-0">
                      <Nav variant="pills" className="card-header-pills">
                        <Nav.Item>
                          <Nav.Link eventKey="1">Developers</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="2">Designers</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="3">Managers</Nav.Link>
                        </Nav.Item>
                      </Nav>
                    </div>
                  </div>
                  ...
                  <Card.Body>
                    ...
                    <Tab.Content className="text-muted">
                      <Tab.Pane eventKey="1" id="bottomtabs-home">
                        ...
                        <p className="mb-2">
                          On the note of consistency, color consistency is a
                          MUST. If you’re not trying to create crazy contrast in
                          your design, then a great idea would be for you to use
                          a color palette throughout your entire design. It will
                          subconsciously interest viewers and also is very
                          pleasing to look at.
                        </p>
                        <p className="mb-0">
                          Any bypasser will stop to see what you have to see,
                          even if your design has nothing to do with them, for
                          the simple fact that it is beautiful to look at.
                        </p>
                      </Tab.Pane>
                      ...
                      <Tab.Pane eventKey="2" id="bottomtabs-profile">
                        ...
                        <p className="mb-0">
                          ...
                          over the lazy fox. The jay, pig, fox, zebra, and my
                          wolves.
                        </p>
                      </Tab.Pane>
                      ...
                      <Tab.Pane eventKey="3" id="bottomtabs-messages">
                        ...
                        <p className="mb-2">
                          ...
                          Phoenix was gazed by MTV for luck. A wizard’s job is
                          to vex chumps quickly in fog. Watch "Jeopardy! ", Alex
                          Trebek's fun TV quiz game. Woven silk pyjamas
                          exchanged for blue quartz. Brawny gods just flocked up
                          to quiz and vex him.
                        </p>
                        <p className="mb-0">
                            ...
                            <div className="d-flex">
                              <div className="flex-grow-1 me-3">
                                <p className="mb-0">
                                  ...
                                  play around with the fonts that you already
                            ...
                            <div className="d-flex mb-4">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  ...
                                  tracking to create a certain artistic effect.
                                  It can also help you fix fonts that are poorly
                                  spaced to begin with. A wonderful serenity has
                            ...
                            <div className="d-flex">
                              <div className="flex-grow-1 me-3">
                                <p className="mb-0">
                                  ...
                                  own style choices. For that very reason, I
                                  went on a quest and spoke to many different
                            ...
                            <div className="d-flex mb-4">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <p className="mb-0">
                                  ...
                                  out master cleanse gluten-free squid scenester
                                  freegan cosby sweater. Fanny pack portland
                                  seitan DIY, art party locavore wolf cliche
                            ...
                            <div className="d-flex">
                              <div className="flex-grow-1 me-3">
                                <p className="mb-0">
                                  ...
                                  sweater eu banh mi, qui irure terry richardson
                                  ex squid.
                                </p>
                              </div>
                              <div className="flex-shrink-0">
          ...
          <Row>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <Card.Body>
                  <p className="text-muted">
                    Example of nav with badge wrapped in nav item.
                  </p>
                  <Tab.Container defaultActiveKey="1">
                    <Nav className="nav-tabs nav-justified mb-3">
                      <Nav.Item>
                        <Nav.Link eventKey="1">Explore</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="2">
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <Card.Body>
                  <p className="text-muted">
                    Use <code>nav-border-top</code> class to create nav with
                    border at top.
                  </p>
                  <Tab.Container defaultActiveKey="1">
              ...
              <Card>
                <Card.Body>
                  <p className="text-muted">
                    ...
                    create nav with border at top with justified tabs position.
                  </p>
                  <Tab.Container defaultActiveKey="1">
              ...
              <Card>
                <Card.Body>
                  ...
                  <Tab.Container defaultActiveKey="1">
                    <Nav
                      variant="pills"
                      className="nav-custom-outline nav-primary mb-3"
                    >
                      <Nav.Item>
                        <Nav.Link eventKey="1">Home</Nav.Link>
                      </Nav.Item>
                        ...
                        >
                          ...
                          <div className="d-flex mt-2">
                            ...
                            <div className="flex-grow-1 ms-2">
                              Too much or too little spacing, as in the example
                              below, can make things unpleasant for the reader.
                              The goal is to make your text as comfortable to
                              read as possible.
                            </div>
                          </div>
                        </div>
                      ...
                      <Tab.Pane eventKey="2" id="nav-colored-profile">
                        <div className="d-flex mb-3">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            right, and each. next level wes anderson artisan
                            four loko farm-to-table craft beer twee. commodo
                      ...
                      <Tab.Pane eventKey="1" id="nav-light-home">
                        <div className="d-flex mb-1">
                          <div className="flex-grow-1 me-3">
                            ...
                            aesthetic magna delectus. pposites attract, and
                            that’s a fact. It’s in our nature to be interested
                      ...
                      <Tab.Pane eventKey="2" id="nav-light-profile">
                        <div className="d-flex mb-1">
                          <div className="flex-grow-1 me-3">
                            Just like in the image where we talked about using
                            multiple fonts, you can see that the background in
                            this graphic design is blurred. Whenever you put
                            text on top of an image, it’s important that your
                            viewers can understand the text, and sometimes that
                            means applying a gaussian readable Any bypasser will
                            stop to see what you have to see, even if your
                            design has nothing to do with them.
                          </div>
                          <div className="flex-shrink-0">
                            <img
                              src={img5}
                      ...
                      <Tab.Pane eventKey="3" id="nav-colored-messages">
                        <div className="d-flex mb-1">
                          <div className="flex-grow-1 me-3">
                            ...
                            cleanse gluten-free squid scenester freegan cosby
                            sweater. Fanny pack portland seitan DIY, art party
                            locavore wolf cliche high life echo park Austin On
                            the note of consistency, color consistency is a
                            MUST. If you’re not trying to create crazy contrast
                            in your design.
                          </div>
                          <div className="flex-shrink-0">
                            <img
