...
const TopPages = () => {
  ...
  const upcoming = [
    ...
    {
      event: "Global GDPR Manual",
      dueDate: "25-09-2024",
    },
    {
      event: "DPIA Guidance Note",
      dueDate: "18-09-2024",
    },
    {
      event: "Third Party",
    ...
    {
      event: "Competence Matrix",
      dueDate: "12-09-2024",
    },
    {
      event: "Fire Drill Report",
      dueDate: "16-09-2024",
    },
  ];
      ...
      <Col xl={4} md={6}>
        <Card className="card-height-100">
          <Card.Header className="align-items-center d-flex">
            <h4 className="card-title mb-0 flex-grow-1">Upcoming Activity</h4>
