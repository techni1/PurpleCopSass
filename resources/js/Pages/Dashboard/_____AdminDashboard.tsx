...
import AuditChart from "./Chart/____AuditChart";
  ...
  const fetchFrameworkData = async (framework: any) => {
    ...
    if (framework && framework.status == 1) {
      try {
        ...
        // Aggregate all status counts (submitted, approved, published, audited)
        ...
        const Published = policyCounts.published + evidenceCounts.published;
