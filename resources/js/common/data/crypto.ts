...
// My Portfolio
const btcPortfolioData:any = [19405, 40552, 15824, 30635];
const usdPortfolioData:any = [9405, 20552, 5824, 20635];
const euroPortfolioData:any = [29405, 50552, 25824, 40635];

// Market Graph
const MarketGraphAll:any = [{
    data: [{
