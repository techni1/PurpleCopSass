                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio">
                                                <input className="form-check-input" type="radio" name="data-body-image" id="body-img-none"
                                                    value={BACKGROUND_IMAGE_TYPES.NONE}
                                                    checked={backgroundImageType === BACKGROUND_IMAGE_TYPES.NONE}
                                                    onChange={e => {
                                                        if (e.target.checked) {
                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio">
                                                <input className="form-check-input" type="radio" name="data-body-image" id="body-img-one"
                                                    value={BACKGROUND_IMAGE_TYPES.IMG1}
                                                    checked={backgroundImageType === BACKGROUND_IMAGE_TYPES.IMG1}
                                                    onChange={e => {
                                                        if (e.target.checked) {
                                                            dispatch(changeBackgroundImageType(e.target.value));
                                                        }
                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio">
                                                <input className="form-check-input" type="radio" name="data-body-image" id="body-img-two"
                                                    value={BACKGROUND_IMAGE_TYPES.IMG2}
                                                    checked={backgroundImageType === BACKGROUND_IMAGE_TYPES.IMG2}
                                                    onChange={e => {
                                                        if (e.target.checked) {
                                                            dispatch(changeBackgroundImageType(e.target.value));
                                                        }
                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio">
                                                <input className="form-check-input" type="radio" name="data-body-image" id="body-img-three"
                                                    value={BACKGROUND_IMAGE_TYPES.IMG3}
                                                    checked={backgroundImageType === BACKGROUND_IMAGE_TYPES.IMG3}
                                                    onChange={e => {
                                                        if (e.target.checked) {
                                                            dispatch(changeBackgroundImageType(e.target.value));
                                                        }
