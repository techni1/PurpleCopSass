...
class SassPackageController extends Controller
{
    ...
    public function store(SassPackageRequest $request)
    {
        ...
        $data['custom_day'] = $request->custom_day;
        $data['instance_config_details'] = $request->instance_config_details;
        $data['file_storage'] = $request->file_storage;
        $data['assigned_personal_manager'] = $request->assigned_personal_manager;
        $data['db_backup'] =  $request->db_backup;
        $data['notification_email'] = $request->notification_email;
        $data['notification_sms'] =  $request->notification_sms;
        $data['notification_call'] =  $request->notification_call;
        $data['custom_featured_request'] = $request->custom_featured_request;
