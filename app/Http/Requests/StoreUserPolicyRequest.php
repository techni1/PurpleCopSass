...
use App\Rules\UniquePolicyEntity;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rules\File;
use Illuminate\Validation\Rule;

class StoreUserPolicyRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'policy_id' => ['required', Rule::exists(Policy::class, 'id'), new UniquePolicyEntity($this->policy_id, $this->entity_id)],
    ...
    {
        return [
            'policy_id.required' => 'The policy is required.',
